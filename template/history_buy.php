<div class="card mb-3 text-white" style="background-color:#2d2d2d;">
	<div class="card-header text-center p-1" style="border-bottom: 3px solid #ff94fd;">
		<span class="text-white" style="display: block;"><i class="fa fa-history"></i>&nbsp;ประวัติการซื้อ</span>
	</div>
	<table id="example" class="table" style="width:100%">
		<thead>
			<tr>
				<th class="text-white">#</th>
				<th class="text-center text-white">รายการ</th>
				<th class="text-center text-white">เวลา</th>
				<th class="text-center text-white">ราคา</th>
				<th class="text-center text-white">เซิฟเวอร์</th>
			</tr>
		</thead>
		<tbody>
			<?php
				$sql_list_topup = 'SELECT * FROM activities WHERE id AND uid = "'.$_SESSION['uid'].'" ORDER BY id ASC';
