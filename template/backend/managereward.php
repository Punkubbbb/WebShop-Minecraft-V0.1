  <?php
    ...
    {
      $product_id = $_GET['id'];
      $sql_f_edit_product = 'SELECT * FROM rp_shop WHERE id = "'.$product_id.'"';
      ...
      if($query_f_edit_product->num_rows != 0)
      {
        ...
        if(isset($_POST['btn_edit_product']))
        {
          ...
          $sql_edit_product = 'UPDATE rp_shop SET name = "'.$_POST['product_name'].'", price = "'.$_POST['product_price'].'", category = "'.$_POST['product_category'].'", command = "'.$_POST['product_command'].'", pic = "'.$_POST['product_pic'].'", server_id = "'.$bungee_edit.'"';
        ...
        {
          $sql_rm_product = 'DELETE FROM rp_shop';
        ...
        ?>
          <h4 class="mb-3 text-center">จัดการแลกของ <div class='text-muted'>#<?php echo $product_f['id']; ?></div></h4>
    ...
    elseif(isset($_GET['action']) && $_GET['action'] != NULL && $_GET['action'] != "" && $_GET['action'] == 'add')
    {
      if(isset($_POST['btn_add_product']))
      {
        ...
        $sql_add_product = 'INSERT INTO rp_shop (name,price,category,command,pic,server_id) VALUES ("'.$_POST['product_name'].'","'.$_POST['product_price'].'","'.$_POST['product_category'].'","'.$_POST['product_command'].'","'.$_POST['product_pic'].'","'.$bungee_add.'")';
      ...
      ?>
        <h4 class="mb-3 text-center">เพิ่มแลกของ</h4>
    ...
    {
      $sql_product = 'SELECT * FROM rp_shop';
            ...
            <div class="item" style="margin-bottom: 20px;">
                ...
                <div class="item-info">
                  <div class="item-text">
                    ...
                    <a href="?page=backend&menu=managereward&id=<?php echo $product['id']; ?>" class="btn btn-success w-100 mb-1 border-0">แก้ไข</a>
                  </div>
                </div>
